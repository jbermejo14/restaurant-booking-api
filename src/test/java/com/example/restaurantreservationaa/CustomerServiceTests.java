...
public class CustomerServiceTests {
    ...
    public void testGetAll() {
        ...
        assertEquals("Manuel", customerList.get(2).getName());
    ...
    public void testAddCustomer() {
        CustomerRegistrationDto customerInDto = new CustomerRegistrationDto("Pablo", "test@email.com", "111111111", "test", "user", Date.valueOf(LocalDate.now()));
        Customer mockCustomer = new Customer(31, "Pablo", "test@email.com", "111111111", "test", "user", Date.valueOf(LocalDate.now()));
        when(customerRepository.save(any(Customer.class))).thenReturn(mockCustomer);

        CustomerOutDto customerOutDto = customerService.add(customerInDto);
        assertEquals("Pablo", customerOutDto.getName());
